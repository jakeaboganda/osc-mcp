...
fn test_scenario_with_custom_triggers_in_esmini() {
    ...
    scenario.set_act_start_trigger("TriggerTestStory", "DelayedAct", act_trigger).unwrap();
    
    // Create maneuver group and add actor
    scenario.add_maneuver_group("TriggerTestStory", "DelayedAct", "EgoManeuverGroup").unwrap();
    scenario.add_actor("TriggerTestStory", "DelayedAct", "EgoManeuverGroup", "Ego").unwrap();
    
    // Create maneuver and event
    scenario.add_maneuver("TriggerTestStory", "DelayedAct", "EgoManeuverGroup", "SpeedManeuver").unwrap();
    ...
    scenario.set_event_start_trigger(
        "TriggerTestStory",
        "DelayedAct",
        "EgoManeuverGroup",
        "SpeedManeuver",
